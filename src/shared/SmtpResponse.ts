...
export class SmtpEnhancedStatusCode {
  public static a_Success: SmtpEnhancedStatusCode = new SmtpEnhancedStatusCode(
    2,
    0,
    0
  );
  public static a_PersistentTransientFailure: SmtpEnhancedStatusCode =
    new SmtpEnhancedStatusCode(4, 0, 0);
  public static a_PermanentFailure: SmtpEnhancedStatusCode =
    new SmtpEnhancedStatusCode(5, 0, 0);

  public static b_OtherOrUndefinedStatus: SmtpEnhancedStatusCode =
    new SmtpEnhancedStatusCode(0, 0, 0);
  public static b_AddressingStatus: SmtpEnhancedStatusCode =
    new SmtpEnhancedStatusCode(0, 1, 0);
  public static b_MailboxStatus: SmtpEnhancedStatusCode =
    new SmtpEnhancedStatusCode(0, 2, 0);
  public static b_MailSystemStatus: SmtpEnhancedStatusCode =
    new SmtpEnhancedStatusCode(0, 3, 0);
  public static b_NetworkAndRoutingStatus: SmtpEnhancedStatusCode =
    new SmtpEnhancedStatusCode(0, 4, 0);
  public static b_MailDeliveryProtocolStatus: SmtpEnhancedStatusCode =
    new SmtpEnhancedStatusCode(0, 5, 0);
  public static b_MessageContentOrMediaStatus: SmtpEnhancedStatusCode =
    new SmtpEnhancedStatusCode(0, 6, 0);
  public static b_SecurityOrPolicyStatus: SmtpEnhancedStatusCode =
    new SmtpEnhancedStatusCode(0, 7, 0);
