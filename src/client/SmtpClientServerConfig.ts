...
export function smtp_commander_server_opts_flags_string(
  opts: SmtpCommanderServerOpts
) {
  let arr: string[] = [];
...
export function smtp_client_server_opts_from_capabilities(
  capabilities: SmtpCapability[]
